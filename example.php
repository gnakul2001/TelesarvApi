...
/* Send an SMS using TeleSarv. You can run this file 3 different ways:
 *
...
// Step 1: Get the TeleSarv API library from https://github.com/gnakul2001/TelesarvApi,
// following the instructions to install it with Composer.

require_once 'src/Class_TeleSarv_API.php';
use UltimateSMS\TelesarvApi;
...
// Step 5: Replace your Install URL like https://mywebhost.com/sms/api with https://demo.telesarvpanel.com/
...
//	message type
$type = "PROMO"; //For Transactional
$type = "TRANS"; //For Promotional
...
// Step 6: instantiate a new TeleSarv API request
